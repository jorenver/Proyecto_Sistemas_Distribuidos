...
@rem ##########################################################################
@rem
@rem  latency-test startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and LATENCY_TEST_OPTS to pass JVM options to this script.
...
@rem Execute latency-test
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LATENCY_TEST_OPTS%  -classpath "%CLASSPATH%" cacheService.LatencyTest %CMD_LINE_ARGS%
...
:fail
rem Set variable LATENCY_TEST_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%LATENCY_TEST_EXIT_CONSOLE%" exit 1
exit /b 1
