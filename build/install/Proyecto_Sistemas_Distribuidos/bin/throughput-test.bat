...
@rem ##########################################################################
@rem
@rem  throughput-test startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and THROUGHPUT_TEST_OPTS to pass JVM options to this script.
...
@rem Execute throughput-test
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %THROUGHPUT_TEST_OPTS%  -classpath "%CLASSPATH%" cacheService.ThroughputTest %CMD_LINE_ARGS%
...
:fail
rem Set variable THROUGHPUT_TEST_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%THROUGHPUT_TEST_EXIT_CONSOLE%" exit 1
exit /b 1
