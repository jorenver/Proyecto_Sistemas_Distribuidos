...
@rem ##########################################################################
@rem
@rem  cliente-throughput startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and CLIENTE_THROUGHPUT_OPTS to pass JVM options to this script.
...
@rem Execute cliente-throughput
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CLIENTE_THROUGHPUT_OPTS%  -classpath "%CLASSPATH%" cacheService.ClienteThroughput %CMD_LINE_ARGS%
...
:fail
rem Set variable CLIENTE_THROUGHPUT_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%CLIENTE_THROUGHPUT_EXIT_CONSOLE%" exit 1
exit /b 1
