...
@rem ##########################################################################
@rem
@rem  cache-algoritmo startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and CACHE_ALGORITMO_OPTS to pass JVM options to this script.
...
@rem Execute cache-algoritmo
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CACHE_ALGORITMO_OPTS%  -classpath "%CLASSPATH%" cacheAlgorithm.AlgoritmoImp %CMD_LINE_ARGS%
...
:fail
rem Set variable CACHE_ALGORITMO_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%CACHE_ALGORITMO_EXIT_CONSOLE%" exit 1
exit /b 1
